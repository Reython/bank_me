...
class Command(BaseCommand):
    help = "Populate predefined error codes."
    ...
    def handle(self, *args, **options):
        errors = [
            ...
            (
                32707,
                "Currency not allowed except 860, 643, 840",
        ...
        for code, en, ru, uz in errors:
            _, was_created = Error.objects.get_or_create(
                code=code,
        ...
        self.stdout.write(self.style.SUCCESS(f"Inserted {created} error codes."))
